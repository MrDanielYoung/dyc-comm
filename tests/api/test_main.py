...
def test_config_check_reports_runtime_flags(monkeypatch):
...
def test_microsoft_callback_redirects_to_web_on_success(monkeypatch):
    ...
    assert session_response.json()["linked_account"] == {
        "email": "daniel@danielyoung.io",
        "display_name": "Daniel Young",
        "has_refresh_token": False,
    }
...
def test_bootstrap_mail_folders_ensures_defaults(monkeypatch):
    ...
    async def fake_ensure_default_mail_folders(access_token: str):
        ...
        return [
            ...
            {"id": "linkedin-id", "displayName": "30 - LinkedIn"},
            {"id": "notifications-id", "displayName": "40 - Notifications"},
            {"id": "marketing-id", "displayName": "50 - Marketing"},
            {"id": "notes-id", "displayName": "60 - Notes"},
            {"id": "contracts-id", "displayName": "70 - Contracts"},
            {"id": "travel-id", "displayName": "80 - Travel"},
            {"id": "it-reports-id", "displayName": "90 - IT Reports"},
        ]
    ...
    assert response.json() == {
        ...
        "ensured_folders": [
            ...
            {
                "id": "linkedin-id",
                "displayName": "30 - LinkedIn",
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "30 - LinkedIn",
                "is_dyc_target": True,
                "canonical_name": "30 - LinkedIn",
            },
            {
                "id": "notifications-id",
                ...
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "40 - Notifications",
                "is_dyc_target": True,
                "canonical_name": "40 - Notifications",
            },
            {
                "id": "marketing-id",
                ...
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "50 - Marketing",
                "is_dyc_target": True,
                "canonical_name": "50 - Marketing",
            },
            {
                "id": "notes-id",
                ...
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "60 - Notes",
                "is_dyc_target": True,
                "canonical_name": "60 - Notes",
            },
            {
                "id": "contracts-id",
                ...
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "70 - Contracts",
                "is_dyc_target": True,
                "canonical_name": "70 - Contracts",
            },
            {
                "id": "travel-id",
                ...
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "80 - Travel",
                "is_dyc_target": True,
                "canonical_name": "80 - Travel",
            },
            {
                "id": "it-reports-id",
                ...
                "ownership": "dyc_managed",
                "routing_state": "active",
                "folder_role": "90 - IT Reports",
                "is_dyc_target": True,
                "canonical_name": "90 - IT Reports",
            },
        ],
    }
...
def test_ensure_default_mail_folders_accepts_legacy_names(monkeypatch):
    existing_folders = [
    ...
    ensured = main.app.router  # keep linter quiet about module import before await
    del ensured
...
def test_classify_folder_marks_legacy_rule_folder():
