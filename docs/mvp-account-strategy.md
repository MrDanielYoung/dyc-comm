...
* `Money` means receipts, invoices, statements, billing notices, payment confirmations, and other non-judgment finance mail.
...
* `LinkedIn`means LinkedIn notifications, connection updates, and LinkedIn-adjacent service messages.
* `Pipedrive` means CRM notifications, sales pipeline updates, and Pipedrive service messages.
